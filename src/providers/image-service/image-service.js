...
var ImageServiceProvider = /** @class */ (function () {
    function ImageServiceProvider(afStorage) {
        this.afStorage = afStorage;
    }
    ImageServiceProvider.prototype.remove = function (image) {
    ...
    ImageServiceProvider.prototype.upload = function (imgMeta, id, folder) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ImageServiceProvider.prototype.generateThumb = function (img, MAX_WIDTH, MAX_HEIGHT, quality, type) {
        var _this = this;
    ...
    ImageServiceProvider.prototype.getImageId = function (imageUrl) {
        var name;
        try {
    ...
    ImageServiceProvider.prototype.generateSquareThumb = function (img, MAX_LENGTH, quality, callback) {
    ...
    ImageServiceProvider.prototype.generateThumbCB = function (img, MAX_WIDTH, MAX_HEIGHT, quality, callback, type) {
        if (MAX_WIDTH === void 0) { MAX_WIDTH = 700; }
        if (MAX_HEIGHT === void 0) { MAX_HEIGHT = 700; }
        if (quality === void 0) { quality = 1; }
        var canvas = document.createElement("canvas");
    ...
    ImageServiceProvider.prototype.getImageSize = function (data_url) {
